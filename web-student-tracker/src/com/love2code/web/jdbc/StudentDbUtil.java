...
public class StudentDbUtil {
	...
	public List<Student> getStudents() throws Exception {
		...
		try {
			...
			//process result set - loop through the results
			...
			// close JDBC objects - allow Eclipse to create the method stub below
	...
	private void close(Connection myConn, Statement myStmt, ResultSet myResults) {
		...
		try {
			...
			if (myConn != null) {
				// put the db connection back in the connection pool
				myConn.close();
			}
		}
		catch (Exception exc) {
